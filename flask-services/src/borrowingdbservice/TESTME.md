...
Add borrow transaction:         curl -i -H "Content-Type: application/json" -X POST -d '{"book_id":1,"patron_id":1,"date_out":"2019-11-14","date_due":"2019-11-29"}' http://0.0.0.0:8002/borrowdb
Delete borrow transaction:      curl -i -H "Content-Type: application/json" -X DELETE -d '{"book_id":1,"patron_id":1}' http://0.0.0.0:8002/borrowdb
```
